...
<div id="Summit" class="summit home">
	...
	<main class="site-content-area" role="main">
		...
		<div class="container">
			<div class="row">
				<div runat="server" id="ContentPane" class="pane col-md-12"></div>
			</div>
			<div class="row">
				<div runat="server" id="Col1of3" class="pane col-md-4 col-sm-4"></div>
				<div runat="server" id="Col2of3" class="pane col-md-4 col-sm-4"></div>
				<div runat="server" id="Col3of3" class="pane col-md-4 col-sm-4 col-xs-12"></div>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row feature-row">
				<div runat="server" id="FeaturedStory" class="pane"></div>
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div runat="server" id="Fullwidth" class="pane col-md-12"></div>
			</div>
		</div>
	</main>
